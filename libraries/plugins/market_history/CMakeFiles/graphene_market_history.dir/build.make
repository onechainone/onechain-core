...
libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/market_history_plugin.cpp.o: libraries/plugins/market_history/market_history_plugin.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/alidata/one-compile/onechain-core/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/market_history_plugin.cpp.o"
	cd /alidata/one-compile/onechain-core/libraries/plugins/market_history && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/graphene_market_history.dir/market_history_plugin.cpp.o -c /alidata/one-compile/onechain-core/libraries/plugins/market_history/market_history_plugin.cpp
...
libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/market_history_plugin.cpp.i: cmake_force
	...
	cd /alidata/one-compile/onechain-core/libraries/plugins/market_history && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /alidata/one-compile/onechain-core/libraries/plugins/market_history/market_history_plugin.cpp > CMakeFiles/graphene_market_history.dir/market_history_plugin.cpp.i
...
libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/market_history_plugin.cpp.s: cmake_force
	...
	cd /alidata/one-compile/onechain-core/libraries/plugins/market_history && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /alidata/one-compile/onechain-core/libraries/plugins/market_history/market_history_plugin.cpp -o CMakeFiles/graphene_market_history.dir/market_history_plugin.cpp.s
...
libraries/plugins/market_history/libgraphene_market_history.a: libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/alidata/one-compile/onechain-core/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX static library libgraphene_market_history.a"
	cd /alidata/one-compile/onechain-core/libraries/plugins/market_history && $(CMAKE_COMMAND) -P CMakeFiles/graphene_market_history.dir/cmake_clean_target.cmake
	cd /alidata/one-compile/onechain-core/libraries/plugins/market_history && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/graphene_market_history.dir/link.txt --verbose=$(VERBOSE)
...
libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/clean:
	cd /alidata/one-compile/onechain-core/libraries/plugins/market_history && $(CMAKE_COMMAND) -P CMakeFiles/graphene_market_history.dir/cmake_clean.cmake
...
libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/depend:
	cd /alidata/one-compile/onechain-core && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /alidata/one-compile/onechain-core /alidata/one-compile/onechain-core/libraries/plugins/market_history /alidata/one-compile/onechain-core /alidata/one-compile/onechain-core/libraries/plugins/market_history /alidata/one-compile/onechain-core/libraries/plugins/market_history/CMakeFiles/graphene_market_history.dir/DependInfo.cmake --color=$(COLOR)
